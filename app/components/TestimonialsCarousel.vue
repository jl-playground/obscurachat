<template>
  <section class="py-12 md:py-20" aria-labelledby="testimonials-title">
    <h2 id="testimonials-title" class="text-3xl md:text-4xl font-bold text-center text-gray-900 dark:text-white mb-12">
      What Our Users Say
    </h2>
    ...
    <div class="relative">
      ...
      <div class="overflow-hidden">
        <transition name="slide-fade" mode="out-in">
          ...
          >
            ...
            >
              <!-- Rating Stars -->
              <div class="flex gap-1 mb-4" :aria-label="`${testimonial.rating} out of 5 stars`">
                <Icon 
                  v-for="i in 5"
                  :key="i"
      ...
      <div class="flex items-center justify-center gap-4 mt-8">
        ...
        >
          <Icon name="lucide:chevron-left" size="24" class="text-primary-600 dark:text-primary-400" />
        </button>

        <!-- Slide Indicators -->
        <div class="flex gap-2" role="tablist" aria-label="Testimonial slides">
          <button
        ...
        <button
          ...
          class="p-3 rounded-full bg-primary-100 dark:bg-primary-900 hover:bg-primary-200 dark:hover:bg-primary-800 transition-colors"
        >
          <Icon name="lucide:chevron-right" size="24" class="text-primary-600 dark:text-primary-400" />
        </button>
      </div>
