...
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/jldev/Projects/3-vps/obscurachat/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/jldev/Projects/3-vps/obscurachat/node_modules/unstorage/dist/index.mjs';
...
import consola, { consola as consola$1 } from 'file:///Users/jldev/Projects/3-vps/obscurachat/node_modules/consola/dist/index.mjs';
...
import { isVNode, toValue, isRef } from 'file:///Users/jldev/Projects/3-vps/obscurachat/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///Users/jldev/Projects/3-vps/obscurachat/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/jldev/Projects/3-vps/obscurachat/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/jldev/Projects/3-vps/obscurachat/node_modules/vue/server-renderer/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/jldev/Projects/3-vps/obscurachat/public"
      ]
    },
    "http": {
      "domains": []
...
const _FhPuZFReeAKOJscqjKBeDSwh9DwOoslhAtaNKDlRY2o = (function(nitro) {
...
const _P_lyOtCp507OIHiPSaNcOlKoxjGG0v0_fPQCXTZlV8w = (nitroApp) => {
...
const getServerEntry = () => import('file:///Users/jldev/Projects/3-vps/obscurachat/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/jldev/Projects/3-vps/obscurachat/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_w5Fm1z = () => Promise.resolve().then(function () { return renderer$1; });
