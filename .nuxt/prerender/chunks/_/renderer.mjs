import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///tmp/obscurachat/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file:///tmp/obscurachat/node_modules/h3/dist/index.mjs';
import { joinURL } from 'file:///tmp/obscurachat/node_modules/ufo/dist/index.mjs';
import destr from 'file:///tmp/obscurachat/node_modules/destr/dist/index.mjs';
import { b as buildAssetsURL, a as appRootTag, c as appRootAttrs, d as appSpaLoaderTag, e as appSpaLoaderAttrs, u as useRuntimeConfig, f as useStorage, g as appId, h as defineRenderHandler, p as publicAssetsURL, i as appTeleportTag, j as appTeleportAttrs, k as appHead, l as getRouteRules, m as useNitroApp } from '../nitro/nitro.mjs';
import { renderToString } from 'file:///tmp/obscurachat/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///tmp/obscurachat/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file:///tmp/obscurachat/node_modules/devalue/index.js';
import { FlatMetaPlugin } from 'file:///tmp/obscurachat/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///tmp/obscurachat/node_modules/unhead/dist/utils.mjs';
import { toValue, isRef, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file:///tmp/obscurachat/node_modules/vue/index.mjs';
